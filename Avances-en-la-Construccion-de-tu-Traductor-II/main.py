...
# Analizador LR con gramática del compilador (Modulo4)
try:
    from Modulo4.analizador_sintactico_lr import AnalizadorSintacticoLR
    USAR_ANALIZADOR_LR = True
except ImportError:
    USAR_ANALIZADOR_LR = False
...
def main() -> None:
    print("=" * 60)
    print("  Avances en la Construcción de tu Traductor II")
    print("  Análisis Léxico y Sintáctico")
    if USAR_ANALIZADOR_LR:
        print("  [Gramática Modulo4 - Tablas LR]")
    print("=" * 60)
    ...
    if USAR_ANALIZADOR_LR:
        sintactico = AnalizadorSintacticoLR(tokens)
    else:
